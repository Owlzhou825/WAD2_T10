...
<?php
    ...
    if($foodType = "pizza"){
        ...
        $sql = 'select Piz_Result,Piz_Descripton from pizza where Piz_Meat=:pizMeat and Piz_Hated=:pizHated and Piz_Cheese=:pizCheese and Piz_Second=:piz2meat';
    ...
    elseif($foodType = "burger"){
        ...
        $sql = 'select Bur_Result,Bur_Descripton from burger where Bur_Bun=:burBun and Bur_Patty=:burPatty and Bur_Hated=:burHated and Bur_Cheese=:burCheese';
        $stmt = $pdo->prepare($sql);
    ...
    elseif($foodType = "pasta"){
        ...
        $pasTop = $_GET['pasTop'];
        $sql = 'select Pas_Result,Pas_Descripton from pasta where Pas_Type=:pasType and Pas_Meat=:pasMeat and Pas_Sauce=:pasSauce and Pas_Topping=:pasTop';
        $stmt = $pdo->prepare($sql);
        $stmt->bindParam(':pasType', $pasType, PDO::PARAM_STR);
        $stmt->bindParam(':pasMeat', $pasMeatd, PDO::PARAM_STR);
    ...
    elseif($foodType = "sandwich"){
        ...
        $sql = 'select San_Result,San_Descripton from sandwich where San_Bread=:sanBread and San_Hated=:sanHated and San_Meat=:sanMeat and San_Cooking=:sanCook';
        $stmt = $pdo->prepare($sql);
    ...
    elseif($foodType = "steak"){
        ...
        $sql = 'select Ste_Result,Ste_Descripton from steak where Ste_Rarity=:steRarity and Ste_Wine=:steWine and Ste_Sauce=:steSauce and Ste_Hated=:steHated';
        $stmt = $pdo->prepare($sql);
    ...
    elseif($foodType = "wings"){
        ...
        $sql = 'select Win_Result,Win_Descripton from wings where Win_Flavour=:winFlav and Win_Dip=:winDip and Win_Cooking=:winCook and Win_Hated=:winHated';
        $stmt = $pdo->prepare($sql);
